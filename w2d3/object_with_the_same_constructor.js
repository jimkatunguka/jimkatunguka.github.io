 ...
 */
 ...
 Obj.prototype = {name: 'Jim'} // this will make it work wrong since the constructor is overwritten

 Obj.prototype.name = 'Jim' // this will add property name to the dafault prorotype keeping the default constructor
